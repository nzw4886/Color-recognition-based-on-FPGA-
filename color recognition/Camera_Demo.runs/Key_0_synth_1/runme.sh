...
HD_PWD='D:/xilinx/xilinx-summer-camp-project/project/Camera_Demo/Camera_Demo.runs/Key_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Key_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Key_0.tcl
