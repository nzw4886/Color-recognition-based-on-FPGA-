...
## green LED
set_property -dict {PACKAGE_PIN J1 IOSTANDARD LVCMOS33} [get_ports o_green_led]
set_property PULLDOWN true [get_ports o_green_led]
...
## button
set_property -dict {PACKAGE_PIN C3 IOSTANDARD LVCMOS33} [get_ports i_key]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_key_IBUF]
