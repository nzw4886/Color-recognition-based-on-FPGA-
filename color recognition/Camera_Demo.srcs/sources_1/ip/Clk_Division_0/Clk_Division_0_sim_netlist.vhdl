...
--               d:/xilinx/xilinx-summer-camp-project/project/Camera_Demo/Camera_Demo.srcs/sources_1/ip/Clk_Division_0/Clk_Division_0_sim_netlist.vhdl
...
entity Clk_Division_0_Clk_Division is
  port (
    ...
    \clk_mode[1]\ : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
entity Clk_Division_0 is
  ...
  attribute X_CORE_INFO of Clk_Division_0 : entity is "Clk_Division,Vivado 2018.2";
end Clk_Division_0;
...
inst: entity work.Clk_Division_0_Clk_Division
     port map (
      ...
      \clk_mode[1]\(0) => \Count0__10_carry__1_i_4_n_1\,
      clk_out => clk_out
    );
end STRUCTURE;
