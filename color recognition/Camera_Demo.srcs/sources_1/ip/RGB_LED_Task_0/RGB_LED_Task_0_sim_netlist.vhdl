...
--               d:/xilinx/xilinx-summer-camp-project/project/Camera_Demo/Camera_Demo.srcs/sources_1/ip/RGB_LED_Task_0/RGB_LED_Task_0_sim_netlist.vhdl
...
entity RGB_LED_Task_0_Clk_Division_0 is
  port (
    ...
    \Period_100mSecond[3]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    \Period_100mSecond[0]\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
    \Period_100mSecond[0]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
...
\Clk_Divide_1_reg[5]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => \Period_100mSecond[0]\(2 downto 0),
      S(0) => \^o\(0)
    );
...
\Clk_Divide_1_reg[9]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \Period_100mSecond[0]_0\(3 downto 0)
    );
...
entity RGB_LED_Task_0_Driver_SK6805 is
  port (
    ...
    LED_IO_reg_0 : out STD_LOGIC;
    clk_10MHz : in STD_LOGIC;
    Rst : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 7 downto 0 );
    \R_Out_reg[7]\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    \B_Out_reg[7]\ : in STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
...
architecture STRUCTURE of RGB_LED_Task_0_Driver_SK6805 is
  ...
  signal \Send_Cnt[9]_i_7_n_0\ : STD_LOGIC;
  signal \Send_Cnt[9]_i_8_n_0\ : STD_LOGIC;
  ...
  signal \Send_State[1]_i_8_n_0\ : STD_LOGIC;
  signal \Send_State[1]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \Data_Cnt[3]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \Data_Cnt[5]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \Data_Cnt[8]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of LED_IO_i_4 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \Send_Cnt[3]_i_4\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \Send_Cnt[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Send_Cnt[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Send_Cnt[8]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Send_Cnt[9]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Send_Cnt[9]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Send_Cnt[9]_i_8\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \Send_State[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \Send_State[1]_i_5\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \Send_State[1]_i_6\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Send_State[1]_i_7\ : label is "soft_lutpair6";
begin
  LED_IO_reg_0 <= \^led_io_reg_0\;
...
\Data_Cnt[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\Data_Cnt[8]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
\Send_Cnt[9]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\Send_Cnt[9]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\Send_Cnt[9]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\Send_State[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5410"
    )
        port map (
...
\Send_State[1]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \Send_State[1]_i_7_n_0\,
      I3 => \Send_State_reg_n_0_[1]\,
      I4 => \Send_State[1]_i_8_n_0\,
      I5 => \Send_State[1]_i_9_n_0\,
      O => Send_State0
    );
...
\Send_State[1]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\Send_State[1]_i_8\: unisim.vcomponents.LUT6
    generic map(
      ...
      O => \Send_State[1]_i_8_n_0\
    );
\Send_State[1]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of RGB_LED_Task_0_RGB_LED_Task is
  ...
  attribute SOFT_HLUTNM of \Cnt_1[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Cnt_1[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Cnt_1[5]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Cnt_1[6]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \Cnt_1[7]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \Cnt_2[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \Cnt_2[2]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \Cnt_2[3]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Cnt_2[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Cnt_2[6]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Cnt_2[7]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \Cnt_2[7]_i_4\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Cnt_2[8]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \Cnt_3[1]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \Cnt_3[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Cnt_3[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Cnt_3[6]_i_2\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \Cnt_3[9]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \G_Out[2]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \G_Out[3]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \G_Out[4]_i_1\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \Light_Cnt[0]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \Light_Cnt[10]_i_3\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \Light_Cnt[1]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \Light_Cnt[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Light_Cnt[3]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Light_Cnt[5]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \Light_Cnt[6]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \Light_Cnt[7]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \Light_Cnt[8]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \Light_Cnt[9]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of RGB_State_i_1 : label is "soft_lutpair23";
...
Clk_Division1: entity work.RGB_LED_Task_0_Clk_Division_0
     port map (
      ...
      \Period_100mSecond[0]\(2) => \Clk_Divide_1[5]_i_3_n_0\,
      \Period_100mSecond[0]\(1) => \Clk_Divide_1[5]_i_4_n_0\,
      \Period_100mSecond[0]\(0) => \Clk_Divide_1[5]_i_5_n_0\,
      \Period_100mSecond[0]_0\(3) => \Clk_Divide_1[9]_i_2_n_0\,
      \Period_100mSecond[0]_0\(2) => \Clk_Divide_1[9]_i_3_n_0\,
      \Period_100mSecond[0]_0\(1) => \Clk_Divide_1[9]_i_4_n_0\,
      \Period_100mSecond[0]_0\(0) => \Clk_Divide_1[9]_i_5_n_0\,
      \Period_100mSecond[3]\(0) => \Clk_Divide_1[12]_i_3_n_0\,
...
Driver_SK6805_0: entity work.RGB_LED_Task_0_Driver_SK6805
     port map (
      \B_Out_reg[7]\(7 downto 0) => B_Out(7 downto 0),
      LED_IO_reg_0 => Driver_SK6805_0_n_1,
      Q(7 downto 0) => G_Out(7 downto 0),
      RGB_LED_IO => RGB_LED_IO,
      \R_Out_reg[7]\(7 downto 0) => R_Out(7 downto 0),
      Rst => Rst,
      clk_10MHz => clk_10MHz
    );
...
entity RGB_LED_Task_0 is
  ...
  attribute X_CORE_INFO of RGB_LED_Task_0 : entity is "RGB_LED_Task,Vivado 2018.2";
end RGB_LED_Task_0;
